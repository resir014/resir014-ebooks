...
class CloneBot < Ebooks::Bot
  ...
  def on_startup
    ...
    scheduler.cron '0 */2 * * *' do
      # Every 2 hours, post a single tweet
...
CloneBot.new("resir014_ebooks") do |bot|
  bot.access_token = "700914580835282945-Uzt6PjPXfmHu991GmZVpuVwlbIrdNIz"
  bot.access_token_secret = "GHlg9a20UrRchLmesSIw7EGYop3PQdWmyApDWS2LqgtZ0"

  bot.original = "resir014"
end
